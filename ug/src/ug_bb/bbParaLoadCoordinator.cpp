...
/**@file    bbParaLoadCoordinator.cpp
   ...
   else
   {
      if( initialNodesGenerated )
      {
         if( dynamic_cast<BbParaSolverPoolForMinimization *>(paraSolverPool) )     // paraSolverPool may not be always BbParaSolverPoolForMinimization
         {
            ...
            bbParaInitiator->setTotalFairNodesInfo(dynamic_cast<BbParaSolverPoolForMinimization *>(paraSolverPool)->getFairnodesInfo());
         }
         else
         {
      ...
      else
      {
         if( racingTermination )
         {
            ...
            else
            {
               ...
               bbParaInitiator->setTotalFairNodesInfo(Totalfairnodesinfo);
            }
...
// std::cout << "sendInterrruptRequest 3" << std::endl;
   ...
   case CompTerminatedInRacingStage:
   {
      ...
      Totalfairnodesinfo = calcState->getFairNodesInfo();
