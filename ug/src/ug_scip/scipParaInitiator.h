...
public:
   ...
   ScipParaInitiator(
         ...
         :  UG::BbParaInitiator(inComm, inTimer), paraParams(0), instance(0), solution(0), scipDiffParamSetRoot(0), scipDiffParamSet(0), messagehdlr(0), logfile(0),
            ...
            logname(0), isolname(0), generatedIsolname(0), solutionFileName(0), userPlugins(0), finalDualBound(-DBL_MAX), finalState(UG::Aborted), nSolved(0), nfairnodes(0), fairnodesinfo(7, 0),             absgap(-1.0), gap(-1.0), objlimit(DBL_MAX), qsol(false)
#ifdef UG_WITH_UGS
            , seqNumber(0)
#endif
   {
